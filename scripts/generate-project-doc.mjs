...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      bullet("GST compliance requires proper slab-wise tax calculation (0%, 5%, 18%, 40%)"),
      ...
      bullet("Allowed GST rates constrained: CHECK constraint limits to 0, 5, 18, 40 — the actual Indian GST slabs"),
      ...
      makeTable(
        ...
        [
          ["0%", "milk, fresh vegetable, vegetable, fruit, egg, tetra-pack milk, loose staples (atta, rice, dal, chawal, gehun)"],
          ["5%", "packaged/branded staples, ghee, butter, cheese, juice, chips, tea, coffee, biscuit, namkeen, sugar, salt, oil"],
          ["18%", "soap, detergent, shampoo, toothpaste, dishwash, dish soap"],
          ["40%", "cold drink, aerated drink, pan masala"],
